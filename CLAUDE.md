...
| `phone` | string (opcjonalne) | Numer telefonu w stopce — pusty = ukryty |
| `companyTaxId` | string (opcjonalne) | NIP w stopce — pusty = ukryty |
| `companyRegon` | string (opcjonalne) | REGON w stopce — pusty = ukryty |
